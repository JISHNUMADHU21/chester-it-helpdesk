...
export default function LabelManagePage() {
  ...
  // Filter labels by selected group client-side
  ...
  const saveMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries(['config-labels'])
      closeModal()
    },
  })
      ...
      <div style={{ background: '#fff', border: '1px solid var(--border)', borderRadius: 8, overflow: 'hidden' }}>
        <div style={{ padding: '14px 18px', borderBottom: '1px solid var(--border)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <span style={{ fontSize: 14, fontWeight: 600 }}>
            {selectedGroup ? `${selectedGroup.name} — Labels` : 'All Labels'}
          </span>
        ...
        {isLoading ? (
          ...
          <div style={{ textAlign: 'center', padding: '48px 20px', color: 'var(--text-muted)' }}>
            ...
            <p style={{ fontSize: 13 }}>
              {selectedGroup ? `No labels assigned to ${selectedGroup.name}.` : 'Create your first label above.'}
            </p>
          </div>
        ) : (
                ...
                >
                  <td style={{ padding: '13px 18px' }}>
                    <span style={{
                      ...
                      background: (item.colour_hex || '#0052CC') + '22',
                      color: item.colour_hex || '#0052CC',
                    }}>
                      {item.name}
                    </span>
                  </td>
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <span style={{
                ...
                background: colourHex + '22', color: colourHex,
              }}>
                {name || 'Preview'}
              </span>
            </div>
